...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-206753129-1">
    </script>
    <script>
...
<header class="header-section">
    <div class="container">
        <div class="header-wrapper" style="@if(LaravelLocalization::getCurrentLocale() == 'en') direction: ltr; @endif">
            ...
            <ul style="@if(LaravelLocalization::getCurrentLocale() == 'en') direction: ltr; @endif"
                class="menu actionsBtn">
...
<img style="bottom: -97px; position: relative; width: 112%; margin: 0; padding: 0; height: 109px; z-index: 999999;" src="{{asset('images/fadeFooterUpper.png')}}">
<footer class="footer-section" style="background:#222751;padding-top: 113px;">
    <div class="container">
        <div class="footer-top pb-4 @if(LaravelLocalization::getCurrentLocale() == 'en') flex-row-reverse @endif">
            ...
            <div class="col-md-2 mb-4 p-0 logo ">
                <p style="color: #FFF; font-size: 16px; font-weight: 300; line-height: 30px;">
                    {{__('main.footer4')}}
                    <img
                        style="width: 35%; display: block; margin-right: 7px; @if(LaravelLocalization::getCurrentLocale() == 'en') left: 0; position: absolute; @endif"
                    ...
                    <li>
                        <a class="pt-2" target="_blank"
                           style="color: #FFF; font-size: 16px; font-weight: 300; line-height: 30px;">
                            <svg
                                class="@if(LaravelLocalization::getCurrentLocale() == 'en') float-left mr-2 @else ml-1 @endif"
                                width="10" fill="#DF8317" xmlns="http://www.w3.org/2000/svg"
                                @if(LaravelLocalization::getCurrentLocale() == 'en') style="transform: rotate(181deg);"
                                @endif
                                viewBox="0 0 256 512">
                                <path
            ...
            <div
                ...
                <p style="color: #FFF; font-size: 16px; font-weight: 300; line-height: 30px;">
                    {{__('main.footer4')}}
                    <img
                        style="width: 24%; display: block; margin-right: 7px; @if(LaravelLocalization::getCurrentLocale() == 'en') left: 0; position: absolute; @endif"
                        src="{{asset('images/carvedLine.png')}}">
                </p>
                <br>
                <ul>
                    <li>
                        <a class="pt-2" target="_blank"
                           style="color: #FFF; font-size: 16px; font-weight: 300; line-height: 30px;">
                            <svg class="@if(LaravelLocalization::getCurrentLocale() == 'en') float-left mr-2 @endif"
                                 width="10" fill="#DF8317" xmlns="http://www.w3.org/2000/svg"
                                 @if(LaravelLocalization::getCurrentLocale() == 'en') style="transform: rotate(181deg);"
                                 @endif
                                 viewBox="0 0 256 512">
                ...
                <ul>
                    <li>
                        <a class="pt-1" target="_blank"
                           style="color: #FFF; font-size: 16px; font-weight: 300; line-height: 30px;">
                            <svg class="@if(LaravelLocalization::getCurrentLocale() == 'en') float-left mr-2 @endif"
                                 width="13" fill="#DF8317" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                                <path
                    ...
                    <li>
                        <a class="pt-1" target="_blank"
                           style="color: #FFF; font-size: 16px; font-weight: 300; line-height: 30px;">
                            <svg class="@if(LaravelLocalization::getCurrentLocale() == 'en') float-left mr-2 @endif"
                                 width="18" fill="#DF8317" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                <path
                    ...
                    <li>
                        <a class="pt-1" target="_blank"
                           style="color: #FFF; font-size: 16px; font-weight: 300; line-height: 30px;">
                            <svg class="@if(LaravelLocalization::getCurrentLocale() == 'en') float-left mr-2 @endif"
                                 width="18" fill="#DF8317" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                <path
        ...
        <div class="footer-bottom">
            <p class="links d-block text-center text-white" dir="rtl" style="color:#f57c00; padding-right: 50px;">
