                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <div class="col-lg-12 margin-tb">
                            <a class="btn pull-left btn-primary btn-sm" href="{{ route('client.categories.create') }}"><i
                                    class="fa fa-plus"></i> {{ __('sidebar.add-new-main-category') }} </a>
                            <h5 class="pull-right alert alert-sm alert-success">{{ __('categories.show-all-categories') }}
                            </h5>
                        </div>
                        <br>
                    </div>
                        ...
                        <table class="table table-condensed table-striped table-bordered text-center table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">{{ __('categories.category-name') }}</th>
                                    <th class="text-center">{{ __('categories.category-type') }}</th>
