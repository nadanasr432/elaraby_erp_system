    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mg-b-20">
                <div class="card-body">
                    <div class="col-12">
                        <a class="btn btn-primary btn-sm pull-left" href="{{ route('client.subcategories.index') }}">
                            {{ __('main.back') }}</a>
                    ...
                    <form class="parsley-style-1" id="selectForm2" name="selectForm2"
                        action="{{ route('client.subcategories.store', 'test') }}" enctype="multipart/form-data"
                        method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input dir="rtl" required class="form-control" name="sub_category_name" type="text">
                            </div>
