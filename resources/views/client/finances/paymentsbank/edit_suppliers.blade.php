            ...
            <div class="card mg-b-20">
                <div class="card-body">
                    ...
                    <form class="parsley-style-1" id="selectForm2" name="selectForm2"
                        action="{{ route('client.update.cashbank.suppliers', $buy_cash->id) }}" enctype="multipart/form-data"
                        method="post">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="row mb-3 bank">
                            <div class="col-md-4">
                                ...
                                <select style="display: inline !important;" name="bank_id" class="form-control">
                                    ...
                                    @foreach ($banks as $bank)
                                        <option @if ($bank->id == $buy_cash->bank_id) selected @endif
                            ...
                            <div class="col-md-4">
                                ...
                                <input value="{{ $buy_cash->bank_check_number }}" type="text" class="form-control"
                                    name="bank_check_number" />
                            </div>
                            <div class="col-md-4">
                                <label class="d-block"> ملاحظات <span class="text-danger">*</span></label>
                                <input value="{{ $buy_cash->notes }}" type="text" class="form-control" name="notes" />
                            </div>
                        </div>
