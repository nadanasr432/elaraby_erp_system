                    ...
                    <div class="d-flex justify-content-between">
                        <div class="col-lg-12 margin-tb">
                            <a class="btn pull-left btn-primary btn-sm"
                               href="{{ route('client.give.cash.suppliers') }}"><i
                                    class="fa fa-plus"></i> سلفية من مورد </a>
                            <h5 class="pull-right alert alert-sm alert-success">السلفيات السابقة من الموردين  </h5>
                        </div>
                        <br>
                    </div>
                </div>
                        ...
                        <table class="table table-condensed table-striped table-bordered text-center table-hover"
                            ...
                            @foreach ($buy_cashs as $key => $cash)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('client.edit.borrow.suppliers', $cash->id) }}"
       ...
       <div class="modal" id="modaldemo9">
            <div class="modal-dialog modal-dialog-centered" cash="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('client.destroy.borrow.suppliers', 'test') }}" method="post">
                        {{ method_field('delete') }}
                        {{ csrf_field() }}
