    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mg-b-20">
                <div class="card-body">
                    <div class="col-12">
                        <a class="btn btn-primary btn-sm pull-left" href="{{ route('client.borrow.clients') }}">
                            سلفات سابقة الى العملاء
                        </a>
                    ...
                    <form class="parsley-style-1" id="selectForm2" name="selectForm2"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input required class="form-control" value="{{ abs($cash->amount) }}" name="amount"
                                    type="text" dir="ltr">
                            </div>
                        </div>
                        <div class="row mb-3">
