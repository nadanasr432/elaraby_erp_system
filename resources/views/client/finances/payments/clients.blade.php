                    ...
                    <div class="d-flex justify-content-between">
                        <div class="col-lg-12 margin-tb">
                            <a class="btn pull-left btn-primary btn-sm"
                               href="{{ route('client.add.cash.clients') }}"><i
                                    class="fa fa-plus"></i> استلام نقدية من عميل </a>
                            <h5 class="pull-right alert alert-sm alert-success">دفعات النقدية السابقة من العملاء</h5>
                        </div>
                        <br>
                    </div>
                </div>
