...
@section('content')
    ...
    <div class="col-lg-12 no-print" style="padding-top: 25px;height: 40px !important;margin-bottom:60px;">
        ...
        <form
            style="display:none;padding-top: 18px; height: 72px !important; margin-bottom: 15px; background: white; border-radius: 5px; box-shadow: rgb(100 100 111 / 6%) 0px 7px 29px 0px; margin-top: -9px !important;"
            id='saveANDPRINT' action="{{ route('client.quotations.redirectANDprint') }}"
            method="POST">
            @csrf
            @method('POST')
