            ...
            <table
                ...
                @php $counter = 1; @endphp
                    @foreach($products as $product)
                        ...
                        @endphp
                        <tr class="even" style="font-size: 15px !important; height: 40px !important; text-align: center;">
                            <td class="borderLeftH">{{$prodTax + $product->quantity_price}} {{$company->extra_settings->currency}}</td>
                            ...
                            <td class="borderLeftH" dir="rtl">
                                {{$product->quantity}} {{$product->product->unit ? $product->product->unit->unit_name : '-'}}
                            </td>
                            <td class="borderLeftH" dir="rtl">
                                {{$product->product_price}} {{$company->extra_settings->currency}}
                            </td>
