                        ...
                        <tbody style="font-size: 14px !important;">
                            ...
                            if (!$elements->isEmpty()) {
                                ...
                                foreach ($elements as $element) {
                                    ...
                                    $discountNote = isset($discountNote) ? $discountNote : '';
                                    $discountPercentage = round(($discountValue / $realtotal) * 100, 1);
                            
                                    $tableRow .= '<td>' . $discountNote . '(' . $discountPercentage . '%) ' . $discountValue . '</td>';
