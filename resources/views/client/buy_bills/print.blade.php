...
<body style="background: #fff">
            ...
            <tr>
                <td class="thisTD">
                    <center style="margin:20px auto;">
                        <span style="font-size:18px;font-weight:bold;border:1px dashed #333; padding: 5px 30px;"> فاتورة
                            ضريبية مشتريات </span>
                    </center>
                    ...
                    echo "<tr style='text-align:center;'>
                                                            <td style='text-align:center;' colspan='2'> المبلغ المتبقى : " .
                        $rest .
                        ' ' .
                        $currency .
                        " </td>
    ...
    <a href="{{ route('client.buy_bills.create') }}" class="no-print btn btn-md btn-danger text-white"> العودة الى
        فاتورة
        المشتريات </a>
