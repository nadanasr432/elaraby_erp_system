                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <div class="col-lg-12 margin-tb">
                            <a class="btn pull-left btn-primary btn-sm" href="{{ route('client.depreciations.create') }}"><i
                                    class="fa fa-plus"></i> اضافة اهلاك جديد </a>
                            <h5 class="pull-right alert alert-sm alert-success">عرض كل عمليات الاهلاك
                            </h5>
                        </div>
                        <br>
                    </div>
                        ...
                        <table class="table table-condensed table-striped table-bordered text-center table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">تصنيف الاصل</th>
                                    <th class="text-center">اسم الاصل</th>
                                    <th class="text-center">من فترة</th>
                                    <th class="text-center">الي فترة</th>
