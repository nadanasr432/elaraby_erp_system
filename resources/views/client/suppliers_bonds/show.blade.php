                ...
                <div class="card-body">
                    ...
                    <div class="row" style="padding: 12px; border: 1px solid gray; margin: 10px;">
                        <div class="col-6" style="border-left:1px solid gray;">
                            <span style="font-size: 18px !important; color: black; font-weight: 600 !important; margin-left: 11px;@if( Config::get('app.locale') == 'en' ) float:right; @endif">{{ __('bonds.supplier_name') }} :</span>
                            <span style="font-size: 17px !important;color:color: #5c5858; font-weight: 600;">{{$supplierBond->supplier}}</span>
                        </div>
                        
                        <div class="col-6">
                            <span style="font-size: 18px !important; color: black; font-weight: 600 !important; margin-left: 11px;">{{ __('bonds.account') }} :</span>
                            <span style="font-size: 17px !important;color: #5c5858; font-weight: 600;">{{$supplierBond->account}}</span>
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding: 12px; border: 1px solid gray; margin: 10px;">
                        <div class="col-6" style="border-left:1px solid gray;">
                            ...
                            <span style="font-size: 17px !important;color: #5c5858; font-weight: 600;">{{$supplierBond->type}}</span>
                        </div>
                        
                        <div class="col-6">
                            <span style="font-size: 18px !important; color: black; font-weight: 600 !important; margin-left: 11px; @if( Config::get('app.locale') == 'en' ) float:right; @endif">
                                {{ __('bonds.date') }}  :</span>
                            <span style="font-size: 17px !important;color: #5c5858; font-weight: 600;">{{$supplierBond->date}}</span>
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding: 12px; border: 1px solid gray; margin: 10px;">
                        <div class="col-6" style="border-left:1px solid gray;">
                            ...
                            <span style="font-size: 17px !important;color: #5c5858; font-weight: 600;">{{$supplierBond->amount}}</span>
                        </div>
                        <div class="col-6" style="border-left:1px solid gray;">
                    ...
                    <div class="row" style="margin: 10px;">
                         ...
                         <button onclick="printThisPage()" style="border-color: #ff4961 !important; background-color: #ff4961 !important; color: #FFFFFF; font-weight: bold; font-size: 15px !important;" class="w-50 btn btn-info pd-x-20" type="submit">{{ __('bonds.print') }}</button>
                          ...
                          <button id="backk" onclick="window.location.href='https://elaraby-erp.net/ar/client/suppliers-bonds/index'" style="border-color: #2C303B !important; background-color: #2C303B !important; color: #FFFFFF; font-weight: bold; font-size: 15px !important;" class="w-50 btn btn-info pd-x-20" type="submit">{{ __('bonds.back') }}</button>
                    </div>
                </div>
            </div>
        </div>
