                    ...
                    <form class="parsley-style-1" id="selectForm2" name="selectForm2"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3 mt-2">
                                ...
                                <input required class="form-control" dir="ltr" id="amount" name="amount" type="number">
                            </div>
...
$(document).ready(function(){
    $("#selectForm2").submit(function(e){
        ...
        console.log(company_id + client + account + type + date + amount);
        ...
        //start Ajax...
        $.ajax({
           url:"{{route('create-suppliers-bonds')}}",
           type:"POST",
           data:{
           ...
           success:function(res){
                if(res){
                    ...
                    setTimeout(function(){
                        window.location.href="/client/showSupplierBondPrint/"+res;
                    },2000);
                }else{
                    alert("not" + res);
                }
