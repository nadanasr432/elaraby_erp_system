...
<div class="content">
    ...
    <p class="error-title">The Application is Down Due To Maintenance</p>
    <p class="m-b-20">We're sorry, but the server was unable to complete your request. You can Go homepage or try the search bar below.
