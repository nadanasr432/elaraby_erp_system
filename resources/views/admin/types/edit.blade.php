            ...
            <div class="card mg-b-20">
                <div class="card-body">
                    ...
                    <form class="parsley-style-1" id="selectForm2" name="selectForm2"
                          action="{{route('admin.types.update',$type->id)}}" enctype="multipart/form-data"
                          method="post">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <input value="{{$type->type_name}}" dir="rtl" required class="form-control"
                                       name="type_name" type="text">
                            </div>
                            <div class="col-md-3">
                                <label> سعر الاشتراك <span class="text-danger">*</span></label>
                                <input value="{{$type->type_price}}" required class="form-control" dir="ltr"
                                       name="type_price" type="text">
                            </div>
                            <div class="col-md-3">
                                <label> مدة الاشتراك بالايام <span class="text-danger">*</span></label>
                                <input required value="{{$type->period}}" class="form-control" dir="ltr" name="period"
                                       type="text">
                            </div>
                            <div class="col-md-3">
